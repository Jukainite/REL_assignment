...
if __name__ == "__main__":
    train = False  # Set to False if you do not want to train
    test = True  # Set to False if you do not want to test
    ...
    if train:
        ...
        # Change opponent to second_opponent and continue training
    ...
    if test:
        ...
        # Test against the first opponent
        finished_episodes = 0
        try:
        ...
        # Test against the second opponent
        finished_episodes = 0
        env_player._opponent = second_opponent
        try:
            env_player.reset_battles()
